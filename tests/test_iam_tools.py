...
class TestIAMUsersManagement:
    ...
    @pytest.mark.asyncio
    async def test_iam_users_list_success(
    ...
    @pytest.mark.asyncio
    async def test_iam_users_list_pagination(
        self, mock_http_client, mock_token_manager, sample_users_list
    ):
        """Test users list with pagination."""
        mock_http_client.get.return_value = sample_users_list

        result = await iam_users_list(workspace="testworkspace", page=2, page_size=50)
    ...
    @pytest.mark.asyncio
    async def test_iam_user_create_success(
        self, mock_http_client, mock_token_manager, sample_user
    ):
    ...
    @pytest.mark.asyncio
    async def test_iam_user_update_success(
        self, mock_http_client, mock_token_manager, sample_user
    ):
    ...
    async def test_iam_user_delete_success(self, mock_http_client, mock_token_manager):
        ...
        result = await iam_user_delete(user_id="user-123", workspace="testworkspace")
    ...
    @pytest.mark.asyncio
    async def test_iam_user_permissions_get_success(
        ...
        result = await iam_user_permissions_get(
            user_id="user-123", workspace="testworkspace"
        )
    ...
    @pytest.mark.asyncio
    async def test_iam_user_assign_role_success(
        self, mock_http_client, mock_token_manager
    ):
        ...
        result = await iam_user_assign_role(
            user_id="user-123", role_id="role-456", workspace="testworkspace"
        )
...
class TestIAMRolesAndPermissions:
    ...
    @pytest.mark.asyncio
    async def test_iam_permissions_list_success(
        self, mock_http_client, mock_token_manager
    ):
...
class TestErrorHandling:
    ...
    async def test_http_error_handling(self, mock_http_client, mock_token_manager):
        ...
        result = await iam_user_get(user_id="nonexistent", workspace="testworkspace")
...
class TestParameterValidation:
    ...
    async def test_pagination_parameters(self, mock_http_client, mock_token_manager):
        ...
        await iam_users_list(workspace="test", page=2, page_size=50)
    ...
    async def test_different_regions(self, mock_http_client, mock_token_manager):
        ...
        await iam_users_list(workspace="test", region="us1")
