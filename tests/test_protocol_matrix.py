...
async def test_2025_revisions_are_echoed_back(revision):
...
@pytest.mark.asyncio
async def test_initialize_does_not_negotiate_the_2026_revision():
...
@pytest.mark.asyncio
async def test_discover_reports_the_2026_revision_and_the_package_version():
